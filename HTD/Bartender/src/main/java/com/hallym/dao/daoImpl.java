...
public class daoImpl implements dao {
  ...
  public int deleteReply2(replyVO r) throws Exception {
	...
	@Override
	public int getout(int user_no, String user_id) throws Exception {
		userVO u = new userVO();
		u.setUser_no(user_no);
		u.setUser_id(user_id);
		
		int result = this.sqlSession.delete("com.hallym.mybatis.sql.bartender.getout1", u);
		this.sqlSession.delete("com.hallym.mybatis.sql.bartender.getout2", u);
		this.sqlSession.delete("com.hallym.mybatis.sql.bartender.getout3", u);
		this.sqlSession.update("com.hallym.mybatis.sql.bartender.getout4", u);
		return result;
	}
}
