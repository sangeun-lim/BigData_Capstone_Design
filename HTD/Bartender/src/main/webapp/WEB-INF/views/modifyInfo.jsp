...
<script>
	...
	function getout(){
		var result = confirm('바로 탈퇴되며, 게시글과 댓글에는 아이디가 남습니다. 탈퇴할까요?');
		...
		<div class="col md-12">
			<div class="card" style="width: 70%; margin: 0 auto; height: 500px; padding:20px;">
				...
				<div style="text-align:right">
					<button id="join-submit" onclick="getout()" class="btn btn-primary" style="margin-top:30px;background-color:black; color:red">
						즉시탈퇴<i class="fa fa-check spaceLeft"></i>
					</button>
				</div>
			</div>
		</div>
