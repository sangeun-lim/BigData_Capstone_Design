...
<script>
	...
	function openrefrige(page) {
		...
		if(user_no_s == ''){
			...
			$.ajax({
				...
				success : function(res) {
					if(page == null){
						$('#page2_1').css('font-weight', 'bold');
					} else {
						for(var i = 1; i <= 5; i++){
							if(i == page){
								$('#page2_'+i).css('font-weight', 'bold');
							} else {
								$('#page2_'+i).css('font-weight', '');
							}
						}
					}
					if($('#pagination2').html() == ''){
						$('#pagination2').append('<li class="page-item"><a class="page-link" id="page2_0" onclick="paging2(0)">Previous</a></li><li class="page-item"><a class="page-link" id="page2_1" onclick="openrefrige(1)" style="font-weight:bold">1</a></li><li class="page-item"><a class="page-link" id="page2_2" onclick="openrefrige(2)">2</a></li><li class="page-item"><a class="page-link" id="page2_3" onclick="openrefrige(3)">3</a></li><li class="page-item"><a class="page-link" id="page2_4" onclick="openrefrige(4)">4</a></li><li class="page-item"><a class="page-link" id="page2_5" onclick="openrefrige(5)">5</a></li><li class="page-item"><a class="page-link" id="page2_6" onclick="paging2(1)">Next</a></li>');
					}
					if (page == null) {
						var start = 0;
						var end = 9;
					} else {
						var start = (parseInt($('#page2_' + page).text()) - 1) * 10;
						var end = parseInt($('#page2_' + page).text()) * 10 - 1;
						if(end > res.length){
							end = res.length;
						}
					}
	...
	function paging2(ref) {
		if (ref == 0 && $('#page2_1').text() != 1) {
			$('#page2_1').text(parseInt($('#page2_1').text()) - 5);
			$('#page2_2').text(parseInt($('#page2_2').text()) - 5);
			$('#page2_3').text(parseInt($('#page2_3').text()) - 5);
			$('#page2_4').text(parseInt($('#page2_4').text()) - 5);
			$('#page2_5').text(parseInt($('#page2_5').text()) - 5);
		}
		...
		<div type="button" onclick="closeModal()" style="float:right; margin-bottom:20px; color:black; font-size:30px; color:white">×</div>
			...
			<div style="margin-left:10%;">
				<ul class="pagination" id="pagination2">
					<li class="page-item"><a class="page-link" style="background-color:black; color:white;"id="page2_0" onclick="paging2(0)">Previous</a></li><li class="page-item"><a class="page-link" id="page2_1" onclick="openrefrige(1)" style="background-color:black; color:white;">1</a></li><li class="page-item"><a class="page-link" id="page2_2" onclick="openrefrige(2)"style="background-color:black; color:white;">2</a></li><li class="page-item"><a class="page-link" id="page2_3" onclick="openrefrige(3)"style="background-color:black; color:white;">3</a></li><li class="page-item"><a class="page-link" id="page2_4" onclick="openrefrige(4)"style="background-color:black; color:white;">4</a></li><li class="page-item"><a class="page-link" id="page2_5" onclick="openrefrige(5)"style="background-color:black; color:white;">5</a></li><li class="page-item"><a class="page-link" id="page2_6" onclick="paging2(1)"style="background-color:black; color:white;">Next</a></li>
				</ul>
			</div>
		</div>
	</div>
